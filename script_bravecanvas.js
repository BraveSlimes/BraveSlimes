...
const slimeFiles = [
    "bravecanvas_sprites/Slime_01.png",
    "bravecanvas_sprites/Slime_02.png",
    "bravecanvas_sprites/Slime_03.png",
    "bravecanvas_sprites/Slime_04.png",
    "bravecanvas_sprites/Slime_05.png",
    "bravecanvas_sprites/Slime_06.png",
    "bravecanvas_sprites/Slime_07.png",
    "bravecanvas_sprites/Slime_08.png",
    "bravecanvas_sprites/Slime_09.png",
    "bravecanvas_sprites/Slime_10.png"
];

const backgroundFiles = [
    "bravecanvas_sprites/Background_01.png",
    "bravecanvas_sprites/Background_02.png",
    "bravecanvas_sprites/Background_03.png",
    "bravecanvas_sprites/Background_04.png",
    "bravecanvas_sprites/Background_05.png",
    "bravecanvas_sprites/Background_06.png",
    "bravecanvas_sprites/Background_07.png",
    "bravecanvas_sprites/Background_08.png",
    "bravecanvas_sprites/Background_09.png",
    "bravecanvas_sprites/Background_10.png"
];
...
realInput.addEventListener('change', function(e){
    ...
    reader.onload = function(){
        ...
        setTimeout(drawUpload, 250);
    }
    // reader가 이미지 읽도록 하기
})

function drawUpload(){
    ctx3.drawImage(uploadImage, 0, 0, canvas3.width, canvas3.height);
}